...
public class ImmutableCollectionsTest {
    ...
    public static void main(String[] args) {
        ...
        set.remove("RED");
        log.info("unmodifiableSet.size(): {}", unmodifiableSet.size());
        ...
        set.remove("RED");
        log.info("immutableSet1: {}", immutableSet1);
        log.info("immutableSet2: {}", immutableSet2);
        ...
        log.info("immutableSet3: {}", immutableSet3);
