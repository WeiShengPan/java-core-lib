...
public class RangeSetTest {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println(rangeSet2.contains(21));
		System.out.println(rangeSet2.contains(26));
		System.out.println(rangeSet2.rangeContaining(21));
		System.out.println(rangeSet2.rangeContaining(26));
		System.out.println(rangeSet2.encloses(Range.closed(20, 25)));
		System.out.println(rangeSet2.encloses(Range.closedOpen(1, 20)));
		System.out.println(rangeSet1.span());
		System.out.println(rangeSet2.span());
	}
}
