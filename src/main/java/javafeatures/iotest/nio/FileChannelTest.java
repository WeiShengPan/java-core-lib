...
public class FileChannelTest {
	...
	public static void main(String[] args) throws IOException {
		...
		try (FileChannel fc = new FileOutputStream("src/main/resources/io/output5.txt").getChannel()) {

			fc.write(ByteBuffer.wrap("你好 \n".getBytes()));
		}

		//write from RandomAccessFile
		try (FileChannel fc = new RandomAccessFile("src/main/resources/io/output5.txt", "rw").getChannel()) {
		...
		try (FileChannel fc = new FileInputStream("src/main/resources/io/output5.txt").getChannel()) {
